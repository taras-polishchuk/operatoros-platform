...
Carried forward from v1.0.0-rc1 (`artifacts/release-candidates/rc1/architecture-deltas.md`).
No new architecture deltas were introduced by the v1.0 public-readiness work.
