...
Carried forward from v1.0.0-rc1 (`artifacts/release-candidates/rc1/migration-from-v08.md`).
No migration-path changes between rc1 and v1.0; the v0.8 importer contract is unchanged.
